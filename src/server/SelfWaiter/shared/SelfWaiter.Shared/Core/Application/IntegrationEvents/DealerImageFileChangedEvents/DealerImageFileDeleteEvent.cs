...
{
    public class DealerImageFileDeleteEvent : CorrelatedBy<Guid>, IIntegrationEvent
    {
        public Guid CorrelationId { get; }

        public DealerImageFileDeleteEvent(Guid correlationId, Guid fileId = default, Guid relationId = default, string fileName = null, string path = null, string storage = null, OpeartionTypeEnum operationType = default)
        {
