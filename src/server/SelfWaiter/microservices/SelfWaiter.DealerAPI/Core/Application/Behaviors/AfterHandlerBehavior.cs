...
{
    public sealed  class AfterHandlerBehavior<TRequest, TResponse>(ILogger<TRequest> _logger, IDealerUnitOfWork _dealerUnitOfWork) : IPipelineBehavior<TRequest, TResponse>
